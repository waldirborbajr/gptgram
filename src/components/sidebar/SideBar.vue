...
<template>
  ...
  <div class="relative flex min-h-screen">
    <!-- sidebar -->
    <div class="side-bar">
      <a href="/" class="flex items-center py-3 space-x-2">
        <svg
      ...
      <nav>
        <a
          ...
          <span class="base-text">Home</span>
        </a>
        <a href="/" class="group base-menu"
          ...
          <span class="base-text">Chat</span>
        </a>
        <a href="/" class="group base-menu"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class="base-text">Time</span>
        </a>
        <a href="/" class="group base-menu"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class="base-text">Alarm</span>
        </a>
        <a href="/" class="group base-menu"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class="base-text">Bookmark</span>
        </a>
      </nav>
    </div>
    <!-- main content -->
    <div class="flex-1">
      <!-- header -->
      <div class="bg-slate-500 shadow px-2 py-4">header</div>
      <!-- content -->
      <div class="p-8 text-slate-600 bg-slate-400">content</div>
    </div>
  </div>
</template>
